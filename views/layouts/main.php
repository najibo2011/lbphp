...
<body>
    <div class="app-container">
        ...
        <header class="app-header">
            ...
            <nav class="main-nav">
                <ul>
                    <li<?= isset($currentPage) && $currentPage === 'search' ? ' class="active"' : '' ?>>
                        <a href="index.php"><i class="fas fa-search"></i> Recherche</a>
                    </li>
                    <li<?= isset($currentPage) && $currentPage === 'lists' ? ' class="active"' : '' ?>>
                        <a href="lists.php"><i class="fas fa-list"></i> Listes</a>
                    </li>
                    <li<?= isset($currentPage) && $currentPage === 'followup' ? ' class="active"' : '' ?>>
                        <a href="followup.php"><i class="fas fa-user-plus"></i> Suivi</a>
                    </li>
                    <li<?= isset($currentPage) && $currentPage === 'crm' ? ' class="active"' : '' ?>>
